...
def main():
    ...
    ret,citra2_binary = cv2.threshold(citra2,100,255,cv2.THRESH_BINARY)
    ret,citra4_binary = cv2.threshold(citra4,100,255,cv2.THRESH_BINARY)

    # melakukan operasi and pada setiap pixel citra
